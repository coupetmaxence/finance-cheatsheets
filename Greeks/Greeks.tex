...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Before we start with the computation of the several greeks, it is important to recal the Black-Scholes fomula for an european call and an european put.
	Let $S_0$ be the underlying price at time $0$, let $r$ be the risk-free rate, let $\sigma$ be the volatility of the underlying, let $T$ be the maturity of the option, $K$ the strike price and $\delta$ the dividend rate. We then have :
	$$call(K, T) = S_0 e^{-\delta T} N(d_1) - Ke^{rT}N(d_2)$$
	$$put(K, T) =  Ke^{rT}N(-d_2) - S_0  e^{-\delta T} N(-d_1)$$
